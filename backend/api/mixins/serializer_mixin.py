class SerializerMixin(object):
    ...
    def get_serializer_class(self):
        serializer_class_mapper = {
            ...
            'POST': self.serializer_class_post or self.serializer_class_create or self.serializer_class_write,
            'PUT': self.serializer_class_put or self.serializer_class_update or self.serializer_class_write,
            'PATCH': self.serializer_class_patch or self.serializer_class_update or self.serializer_class_write,
        }
