...
function Completed({ lng, lngDict, selfUser, couponSelling }) {
  ...
  return (
    <Layout
      ...
      title={`${i18n.t('remittanceCompleted')} - ${i18n.t('_appName')}`}
    >
      <Section
        backButton
        title={i18n.t('remittanceCompleted')}
      >
        <AlertBox content={i18n.t('_couponTradeConfirmationRequested')} variant='success' />
        <Box marginY={1}>
          <Button
            color='primary'
            fullWidth
