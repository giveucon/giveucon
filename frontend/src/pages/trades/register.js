...
function Register({ lng, lngDict, selfUser, selfCouponList }) {
    ...
    return (
        <Layout
            ...
            title={`${i18n.t('registerSelling')} - ${i18n.t('_appName')}`}
        >
            <Section
                backButton
                title={i18n.t('registerSelling')}
            >
            </Section>
            <Section
                title={i18n.t('sellingInfo')}
                titlePrefix={<IconButton><InfoIcon /></IconButton>}
            >
            </Section>
            <Section
                title={i18n.t('selectCoupon')}
